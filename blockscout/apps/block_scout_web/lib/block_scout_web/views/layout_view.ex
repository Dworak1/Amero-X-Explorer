defmodule BlockScoutWeb.LayoutView do
  ...
  def logo do
    System.get_env("LOGO") || Keyword.get(application_config(), :logo)
  end

  def logo_footer do
    System.get_env("LOGO_FOOTER") || System.get_env("LOGO") || Keyword.get(application_config(), :footer)[:logo] || Keyword.get(application_config(), :logo)
  end

  def logo_text do
    System.get_env("LOGO_TEXT") || Keyword.get(application_config(), :logo_text) || nil
  end

  def subnetwork_title do
    System.get_env("SUBNETWORK") || Keyword.get(application_config(), :subnetwork) || "Mainnet"
  end

  def network_title do
    System.get_env("NETWORK") || Keyword.get(application_config(), :network) || "Amero X"
  end
